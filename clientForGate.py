...
data = [{"id": 200, "name": "TheCobra", "age": 1000}, {"id": 2, "name": "Joe", "age": 78,'yearsOfExperience': 100 },
{"id": 3, "name": "Dean", "age": 26}, {"id": 77, "name": "Magic", "age": 78,'yearsOfExperience': 100 },
{"id": 10, "name": "Barak", "age": 26,'yearsOfExperience': 20 }]

#EMPLOYEE HANDLING
#response = requests.post(BASE + "employees/add", data[1])
#response = requests.post(BASE + "employees/librarian/add", data[3]) 
...
response = requests.post(BASE + "books/add", book_data[1])
